...
#########################
current_user = CurrentUser(first_name='Josiah', last_name='Arroyo', email='josiaharroyo2024@u.northwestern.edu', username='josiaharroyo')
